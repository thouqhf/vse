...

{
  ...
  environment.systemPackages = with pkgs; [ 
    ...
    sddm-sugar-dark qt5.qtbase qt5.qtsvg qt5.qtquickcontrols2 qt5.qtgraphicaleffects qt5.qtvirtualkeyboard
    polkit_gnome bluez bluez-tools blueman wl-clipboard wl-clip-persist
